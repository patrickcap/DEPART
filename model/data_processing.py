...
def load_data(data_path):
    """
    Copy data into a dataframe and return it
    """
...
def compute_delay_helper(actual_date_time, sched_date_time):
    """
    Calculate and return if a flight was delayed
    """
...
def drop_columns(df):
    """
    Remove features that will not be used for training
    """
...
def process_add_columns(df):
    """
    Add the engineered features to the raw dataframe
    """
...
def split_dataset(df):
    """
    Divide dataset into training and testing sections
    """
